...
describe "Simon dice" do
  describe "echo" do
    it "should echo hola" do
      expect(echo("hola")).to eq "hola"
    end

    it "should echo adios" do
      expect(echo("adios")).to eq "adios"
    end
  end
...
# You can use default arguments to take a different number of arguments
# ex: def cheese(type, temperature = 'hot')
  ...
  describe "start_of_word" do
    it "returns the first letter" do
      expect(start_of_word("hola", 1)).to eq "h"
    end
...
# These last two may not be solvable with logic. You might need exceptions stored in a variable.
